  ...
  return (
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex w-1/2 bg-secondary p-12 items-center justify-center relative overflow-hidden">
        {/*
          Keep the hero as a real image instead of a CSS background. This lets
          the browser prioritize and decode it without waiting for React and
          the generated stylesheet to finish loading.
        */}
        <img
          src={`${import.meta.env.BASE_URL}login-hero.avif`}
          alt=""
          aria-hidden="true"
          width={1200}
          height={800}
          loading="eager"
          fetchPriority="high"
          className="absolute inset-0 h-full w-full object-cover object-center opacity-30 mix-blend-overlay"
        />
