      ...
      <main className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link href="/register">
              <Button size="lg" className="rounded-full text-base px-8 shadow-md hover:shadow-lg transition-all h-14">
                Start Basic <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <p className="text-sm text-muted-foreground sm:ml-4">No credit card required</p>
          </div>
          <Link href="/journey-preview" className="mt-5 text-sm font-semibold text-primary hover:underline underline-offset-4">
            Preview the new refinish-to-list journey
          </Link>
        </section>
        ...
        <section id="pricing" className="py-24 px-6 max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">Basic is limited access. Pro is the full studio with your own model settings and keys.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-card p-8 rounded-3xl border border-border shadow-sm">
              ...
              <p className="text-muted-foreground mb-8 pb-8 border-b border-border">Limited access for exploring the app. Sign up now, no credit card required.</p>
              <ul className="space-y-4 mb-8">
                {["Browse the studio", "Limited edits and generations", "No credit card required", "Upgrade anytime"].map((feature, i) => (
              ...
              <Link href="/register">
                <Button variant="outline" className="w-full rounded-xl h-12 border-primary text-primary hover:bg-primary/5">Start Basic Access</Button>
              </Link>
            </div>
            ...
            <div className="bg-secondary text-secondary-foreground p-8 rounded-3xl shadow-xl relative overflow-hidden">
              ...
              <p className="text-secondary-foreground/80 mb-8 pb-8 border-b border-secondary-foreground/20">For serious flippers who want full access and custom AI models.</p>
              <ul className="space-y-4 mb-8">
                {["Unlimited AI generations", "All premium room styles", "Add your own API keys", "Choose text, image, and multimodal defaults", "Cancel anytime"].map((feature, i) => (
                  <li key={i} className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-primary" />
                    <span>{feature}</span>
                  </li>
